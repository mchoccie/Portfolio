...
export default function Page() {
  ...
  useEffect(() => {
    ...
    <div className="container">
      ...
      <div id='contactbuttons' className='contactbuttons fade-in' ref={el => sectionsRef.current[3] = el}>
      
        <a href='https://drive.google.com/file/d/1vjS_oVNS0MloaUdFsaZ3Z14cN1o5RTMI/view?usp=sharing' target="_blank" 
        rel="noopener noreferrer" className="btn btn-outline-light custom-button me-4" role="button">View Resume</a>
        <a href='mailto:manancnz@gmail.com' target="_blank" 
        rel="noopener noreferrer" className="btn btn-outline-light custom-button" role="button">Contact Me</a>
      </div>
